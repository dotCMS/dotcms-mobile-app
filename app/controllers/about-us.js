...
var aboutUsParse = function(data) {
    ...
    $.aboutImage.image = Alloy.Globals.dotcms.url + '/contentAsset/image/7de092d3-d051-4898-8623-48113b4ec1ca/fileAsset/byInode/1/filter/Resize/resize_w/' +  Alloy.Globals.platformWidth;
